...
CREATE TABLE `preference` (
  ...
  CONSTRAINT `preference_ibfk_1` FOREIGN KEY (`id`) REFERENCES `basic_details` (`employee_id`),
  CONSTRAINT `preference_ibfk_2` FOREIGN KEY (`department`) REFERENCES `option_master` (`option_value`)
