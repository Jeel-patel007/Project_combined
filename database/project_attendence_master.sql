...
CREATE TABLE `attendence_master` (
  ...
  `stu_status` varchar(250) DEFAULT NULL,
  PRIMARY KEY (`attendence_id`),
  KEY `fk_attendence_master_1_idx` (`studentid`),
  CONSTRAINT `fk_attendence_master_1` FOREIGN KEY (`studentid`) REFERENCES `student_master` (`id`)
